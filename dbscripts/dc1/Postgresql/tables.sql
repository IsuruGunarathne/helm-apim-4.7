...
CREATE SEQUENCE REG_LOG_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE REG_PATH_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE REG_CONTENT_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE REG_RESOURCE_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE REG_COMMENT_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE REG_RESOURCE_COMMENT_PK_SEQ START 1 INCREMENT 2;
CREATE TABLE REG_RESOURCE_COMMENT (
            REG_RESOURCE_COMMENT_ID     INTEGER NOT NULL DEFAULT NEXTVAL('REG_RESOURCE_COMMENT_PK_SEQ'),
...
CREATE SEQUENCE REG_RATING_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE REG_RESOURCE_RATING_PK_SEQ START 1 INCREMENT 2;
CREATE TABLE REG_RESOURCE_RATING (
            REG_RESOURCE_RATING_ID      INTEGER NOT NULL DEFAULT NEXTVAL('REG_RESOURCE_RATING_PK_SEQ'),
...
CREATE SEQUENCE REG_TAG_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE REG_RESOURCE_TAG_PK_SEQ START 1 INCREMENT 2;
CREATE TABLE REG_RESOURCE_TAG (
            REG_RESOURCE_TAG_ID     INTEGER NOT NULL DEFAULT NEXTVAL('REG_RESOURCE_TAG_PK_SEQ'),
...
CREATE SEQUENCE REG_PROPERTY_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE REG_RESOURCE_PROPERTY_PK_SEQ START 1 INCREMENT 2;
CREATE TABLE REG_RESOURCE_PROPERTY (
            REG_RESOURCE_PROPERTY_ID    INTEGER NOT NULL DEFAULT NEXTVAL('REG_RESOURCE_PROPERTY_PK_SEQ'),
...
CREATE SEQUENCE REG_ASSOCIATION_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE REG_SNAPSHOT_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_TENANT_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_DOMAIN_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_USER_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_SYSTEM_USER_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_ROLE_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_MODULE_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_PERMISSION_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_ROLE_PERMISSION_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_USER_PERMISSION_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_USER_ROLE_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_SHARED_USER_ROLE_PK_SEQ START 1 INCREMENT 2;
CREATE TABLE UM_SHARED_USER_ROLE(
    UM_SHARED_USER_ROLE_ID INTEGER NOT NULL DEFAULT NEXTVAL('UM_SHARED_USER_ROLE_PK_SEQ'),
    UM_ROLE_ID INTEGER NOT NULL,
    UM_USER_ID INTEGER NOT NULL,
...
CREATE SEQUENCE UM_ACCOUNT_MAPPING_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_USER_ATTRIBUTE_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_DIALECT_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_CLAIM_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_PROFILE_CONFIG_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_CLAIM_BEHAVIOR_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_HYBRID_ROLE_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_HYBRID_USER_ROLE_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_HYBRID_GROUP_ROLE_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_SYSTEM_ROLE_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_SYSTEM_USER_ROLE_PK_SEQ START 1 INCREMENT 2;
...
CREATE SEQUENCE UM_HYBRID_REMEMBER_ME_PK_SEQ START 1 INCREMENT 2;
...
DROP TABLE IF EXISTS UM_HYBRID_USER_ATTRIBUTE;
DROP SEQUENCE IF EXISTS UM_UUID_DOMAIN_MAPPER_PK_SEQ;
CREATE SEQUENCE UM_UUID_DOMAIN_MAPPER_PK_SEQ START 1 INCREMENT 2;
CREATE TABLE UM_UUID_DOMAIN_MAPPER (
            UM_ID INTEGER DEFAULT NEXTVAL('UM_UUID_DOMAIN_MAPPER_PK_SEQ'),
            UM_USER_ID VARCHAR(255) NOT NULL,
...
CREATE SEQUENCE UM_GROUP_UUID_DOMAIN_MAPPER_PK_SEQ START 1 INCREMENT 2;
CREATE TABLE UM_GROUP_UUID_DOMAIN_MAPPER (
            UM_ID INTEGER DEFAULT NEXTVAL('UM_GROUP_UUID_DOMAIN_MAPPER_PK_SEQ'),
...
SELECT '10084a8d-113f-4211-a0d5-efe36b082211', 'Super', 'This is the super organization.', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'ACTIVE', 'TENANT'
    WHERE NOT EXISTS (SELECT 1 FROM UM_ORG WHERE UM_ID = '10084a8d-113f-4211-a0d5-efe36b082211');

DROP TABLE IF EXISTS UM_ORG_USER;
DROP SEQUENCE IF EXISTS UM_ORG_ATTRIBUTE_PK_SEQ;
CREATE SEQUENCE UM_ORG_ATTRIBUTE_PK_SEQ START 1 INCREMENT 2;
CREATE TABLE UM_ORG_ATTRIBUTE (
            UM_ID INTEGER DEFAULT NEXTVAL('UM_ORG_ATTRIBUTE_PK_SEQ') NOT NULL,
...
CREATE SEQUENCE UM_ORG_PERMISSION_PK_SEQ START 1 INCREMENT 2;
CREATE TABLE UM_ORG_PERMISSION(
            UM_ID INTEGER DEFAULT NEXTVAL('UM_ORG_PERMISSION_PK_SEQ') NOT NULL,
            UM_RESOURCE_ID VARCHAR(255) NOT NULL,
            UM_ACTION VARCHAR(255) NOT NULL,
            UM_TENANT_ID INTEGER DEFAULT 0,
            PRIMARY KEY(UM_ID)
...
DROP TABLE IF EXISTS UM_ORG_USER;
DROP SEQUENCE IF EXISTS UM_ORG_ROLE_USER_PK_SEQ;
CREATE SEQUENCE UM_ORG_ROLE_USER_PK_SEQ START 1 INCREMENT 2;
CREATE TABLE UM_ORG_ROLE_USER (
            UM_ORG_ROLE_USER_ID INTEGER DEFAULT NEXTVAL('UM_ORG_ROLE_USER_PK_SEQ') NOT NULL,
            UM_USER_ID VARCHAR(255) NOT NULL,
            UM_ROLE_ID VARCHAR(255) NOT NULL,
            CONSTRAINT FK_UM_ORG_ROLE_USER_UM_ORG_ROLE FOREIGN KEY (UM_ROLE_ID)
                REFERENCES UM_ORG_ROLE(UM_ROLE_ID) ON DELETE CASCADE,
            PRIMARY KEY(UM_ORG_ROLE_USER_ID)
);

DROP TABLE IF EXISTS UM_ORG_ROLE_GROUP;
DROP SEQUENCE IF EXISTS UM_ORG_ROLE_GROUP_PK_SEQ;
CREATE SEQUENCE UM_ORG_ROLE_GROUP_PK_SEQ START 1 INCREMENT 2;
CREATE TABLE UM_ORG_ROLE_GROUP(
            UM_ORG_ROLE_GROUP_ID INTEGER DEFAULT NEXTVAL('UM_ORG_ROLE_GROUP_PK_SEQ') NOT NULL,
            UM_GROUP_ID VARCHAR(255) NOT NULL,
            UM_ROLE_ID VARCHAR(255) NOT NULL,
            CONSTRAINT FK_UM_ORG_ROLE_GROUP_UM_ORG_ROLE FOREIGN KEY (UM_ROLE_ID)
                REFERENCES UM_ORG_ROLE(UM_ROLE_ID) ON DELETE CASCADE,
            PRIMARY KEY(UM_ORG_ROLE_GROUP_ID)
);

DROP TABLE IF EXISTS UM_ORG_ROLE_PERMISSION;
DROP SEQUENCE IF EXISTS UM_ORG_ROLE_PERMISSION_PK_SEQ;
CREATE SEQUENCE UM_ORG_ROLE_PERMISSION_PK_SEQ START 1 INCREMENT 2;
CREATE TABLE UM_ORG_ROLE_PERMISSION(
            UM_ORG_ROLE_PERMISSION_ID INTEGER DEFAULT NEXTVAL('UM_ORG_ROLE_PERMISSION_PK_SEQ') NOT NULL,
            UM_PERMISSION_ID INTEGER NOT NULL,
            UM_ROLE_ID VARCHAR(255) NOT NULL,
            CONSTRAINT FK_UM_ORG_ROLE_PERMISSION_UM_ORG_ROLE FOREIGN KEY (UM_ROLE_ID)
                REFERENCES UM_ORG_ROLE(UM_ROLE_ID) ON DELETE CASCADE,
            CONSTRAINT FK_UM_ORG_ROLE_PERMISSION_UM_ORG_PERMISSION FOREIGN KEY (UM_PERMISSION_ID)
                REFERENCES UM_ORG_PERMISSION(UM_ID) ON DELETE CASCADE,
            PRIMARY KEY(UM_ORG_ROLE_PERMISSION_ID)
);

DROP TABLE IF EXISTS UM_ORG_USER_PERMISSION;
...
SELECT '10084a8d-113f-4211-a0d5-efe36b082211', '10084a8d-113f-4211-a0d5-efe36b082211', 0
WHERE NOT EXISTS ( SELECT 1 FROM UM_ORG_HIERARCHY WHERE UM_PARENT_ID =
'10084a8d-113f-4211-a0d5-efe36b082211' AND UM_ID = '10084a8d-113f-4211-a0d5-efe36b082211');
