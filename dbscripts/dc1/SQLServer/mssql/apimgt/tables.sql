...
CREATE TABLE IDN_OAUTH2_ACCESS_TOKEN_AUDIT (
            IDN_OAUTH2_ACCESS_TOKEN_AUDIT_ID INTEGER NOT NULL IDENTITY(1,2),
            TOKEN_ID VARCHAR (255),
            ACCESS_TOKEN VARCHAR(2048),
            REFRESH_TOKEN VARCHAR(2048),
            CONSUMER_KEY_ID INTEGER,
...
CREATE TABLE IDN_OAUTH2_SCOPE_BINDING (
  IDN_OAUTH2_SCOPE_BINDING_ID INTEGER NOT NULL IDENTITY(1,2),
...
CREATE TABLE IDN_AUTH_USER_SESSION_MAPPING (
        IDN_AUTH_USER_SESSION_MAPPING_ID INTEGER NOT NULL IDENTITY(1,2),
        USER_ID VARCHAR(255) NOT NULL,
        SESSION_ID VARCHAR(255) NOT NULL,
...
CREATE TABLE IDN_OAUTH2_CIBA_REQUEST_SCOPES (
        IDN_OAUTH2_CIBA_REQUEST_SCOPES_ID INTEGER NOT NULL IDENTITY(1,2),
        AUTH_CODE_KEY CHAR (36),
        SCOPE VARCHAR (255),
...
CREATE TABLE CM_SP_PURPOSE_PURPOSE_CAT_ASSC (
  CM_SP_PURPOSE_PURPOSE_CAT_ASSC_ID INTEGER NOT NULL IDENTITY(1,2),
...
CREATE TABLE CM_PURPOSE_PII_CAT_ASSOC (
  CM_PURPOSE_PII_CAT_ASSOC_ID INTEGER NOT NULL IDENTITY(1,2),
  PURPOSE_ID         INTEGER NOT NULL,
...
CREATE TABLE CM_SP_PURPOSE_PII_CAT_ASSOC (
  CM_SP_PURPOSE_PII_CAT_ASSOC_ID INTEGER NOT NULL IDENTITY(1,2),
  SP_PURPOSE_ASSOC_ID INTEGER NOT NULL,
...
CREATE TABLE CM_CONSENT_RECEIPT_PROPERTY (
  CM_CONSENT_RECEIPT_PROPERTY_ID INTEGER NOT NULL IDENTITY(1,2),
  CONSENT_RECEIPT_ID VARCHAR(255)  NOT NULL,
  NAME               VARCHAR(255)  NOT NULL,
...
CREATE TABLE AM_SUBSCRIBER (
    SUBSCRIBER_ID INTEGER IDENTITY(1,2),
    USER_ID VARCHAR(255) NOT NULL,
    TENANT_ID INTEGER NOT NULL,
...
CREATE TABLE AM_APPLICATION (
    APPLICATION_ID INTEGER IDENTITY(1,2),
...
CREATE TABLE AM_API_PRIMARY_EP_MAPPING (
    MAPPING_ID INTEGER NOT NULL IDENTITY(1,2),
    API_UUID VARCHAR(256) NOT NULL,
...
CREATE TABLE AM_API_URL_MAPPING (
    URL_MAPPING_ID INTEGER IDENTITY(1,2),
    API_ID INTEGER NOT NULL,
...
CREATE TABLE AM_BACKEND_OPERATION_MAPPING (
    MAPPING_ID       INTEGER IDENTITY(1,2),
...
CREATE TABLE AM_API_PRODUCT_MAPPING (
	API_PRODUCT_MAPPING_ID INTEGER IDENTITY(1,2),
	API_ID INTEGER,
...
CREATE TABLE AM_SUBSCRIPTION (
    SUBSCRIPTION_ID INTEGER IDENTITY(1,2),
    TIER_ID VARCHAR(50),
...
CREATE TABLE AM_TIER_PERMISSIONS (
    TIER_PERMISSIONS_ID INTEGER IDENTITY(1,2),
...
CREATE TABLE AM_EXTERNAL_STORES (
    APISTORE_ID INTEGER IDENTITY(1,2),
    API_ID INTEGER,
...
CREATE TABLE AM_API_DEFAULT_VERSION (
            DEFAULT_VERSION_ID INTEGER NOT NULL IDENTITY(1,2),
...
CREATE TABLE  AM_ALERT_TYPES (
            ALERT_TYPE_ID INTEGER NOT NULL IDENTITY(1,2),
...
CREATE TABLE AM_ALERT_EMAILLIST (
	     EMAIL_LIST_ID INTEGER NOT NULL IDENTITY(1,2),
             USER_NAME VARCHAR(255) NOT NULL ,
	     STAKE_HOLDER VARCHAR(100) NOT NULL ,
...
CREATE TABLE AM_POLICY_SUBSCRIPTION (
            POLICY_ID INTEGER IDENTITY(1,2),
...
CREATE TABLE AM_CONDITION_GROUP (
            CONDITION_GROUP_ID INTEGER IDENTITY(1,2),
...
CREATE TABLE AM_QUERY_PARAMETER_CONDITION (
            QUERY_PARAMETER_ID INTEGER IDENTITY(1,2),
...
CREATE TABLE AM_HEADER_FIELD_CONDITION (
            HEADER_FIELD_ID INTEGER IDENTITY(1,2),
            CONDITION_GROUP_ID INTEGER NOT NULL,
...
CREATE TABLE AM_JWT_CLAIM_CONDITION (
            JWT_CLAIM_ID INTEGER IDENTITY(1,2),
            CONDITION_GROUP_ID INTEGER NOT NULL,
...
CREATE TABLE AM_IP_CONDITION (
  AM_IP_CONDITION_ID INTEGER IDENTITY(1,2),
...
CREATE TABLE AM_THROTTLE_TIER_PERMISSIONS (
  THROTTLE_TIER_PERMISSIONS_ID INTEGER IDENTITY(1,2),
...
CREATE TABLE AM_BLOCK_CONDITIONS (
  CONDITION_ID INTEGER IDENTITY(1,2),
...
CREATE TABLE AM_GW_INSTANCES (
    GATEWAY_ID INT IDENTITY(1,2) NOT NULL,
...
CREATE TABLE AM_WEBHOOKS_SUBSCRIPTION (
    WH_SUBSCRIPTION_ID INTEGER IDENTITY(1,2),
...
CREATE TABLE AM_WEBHOOKS_UNSUBSCRIPTION (
    AM_WEBHOOKS_UNSUBSCRIPTION_ID INTEGER IDENTITY(1,2),
    API_UUID VARCHAR(255) NOT NULL,
    APPLICATION_ID VARCHAR(20) NOT NULL,
    TENANT_DOMAIN VARCHAR(255) NOT NULL,
    HUB_CALLBACK_URL VARCHAR(1024) NOT NULL,
...
CREATE TABLE AM_OPERATION_POLICY_DEFINITION (
   DEFINITION_ID INTEGER IDENTITY(1,2),
   POLICY_UUID VARCHAR(45) NOT NULL,
...
CREATE TABLE AM_COMMON_OPERATION_POLICY (
   COMMON_POLICY_ID INTEGER IDENTITY(1,2),
   POLICY_UUID VARCHAR(45) NOT NULL,
   FOREIGN KEY (POLICY_UUID) REFERENCES AM_OPERATION_POLICY(POLICY_UUID) ON DELETE CASCADE,
...
CREATE TABLE AM_API_OPERATION_POLICY (
   API_SPECIFIC_POLICY_ID INTEGER IDENTITY(1,2),
   POLICY_UUID VARCHAR(45) NOT NULL,
...
CREATE TABLE AM_API_OPERATION_POLICY_MAPPING (
   OPERATION_POLICY_MAPPING_ID INTEGER IDENTITY(1,2),
   URL_MAPPING_ID INTEGER NOT NULL,
   POLICY_UUID VARCHAR(45) NOT NULL,
...
CREATE TABLE AM_API_POLICY_MAPPING (
   API_POLICY_MAPPING_ID INTEGER IDENTITY(1,2),
   API_UUID VARCHAR(256) NOT NULL,
   REVISION_UUID VARCHAR(45),
   POLICY_UUID VARCHAR(45) NOT NULL,
   POLICY_ORDER INTEGER NOT NULL,
...
CREATE TABLE AM_GATEWAY_POLICY_MAPPING (
  POLICY_TO_FLOW_INFO_MAPPING_ID INTEGER IDENTITY(1,2),
  GLOBAL_POLICY_MAPPING_UUID     VARCHAR(45)   NOT NULL,
  POLICY_UUID                    VARCHAR(45)   NOT NULL,
  POLICY_ORDER                   INTEGER       NOT NULL,
  DIRECTION                      VARCHAR(10)   NOT NULL,
