CREATE SEQUENCE IDN_OAUTH_CONSUMER_APPS_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_OAUTH_CONSUMER_SECRETS_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_OAUTH2_ACCESS_TKN_ADT_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_ODF_SCOPES_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_OAUTH2_SCOPE_SEQUENCE START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_OAUTH2_SCOPE_BINDING_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_SCIM_GROUP_SEQUENCE START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_STS_STORE_SEQUENCE START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_AUTH_USER_SESSION_MAP_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE SP_APP_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE SP_METADATA_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE SP_INBOUND_AUTH_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE SP_AUTH_STEP_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE SP_CLAIM_DIALECT_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE SP_CLAIM_MAPPING_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE SP_ROLE_MAPPING_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE SP_REQ_PATH_AUTH_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE SP_PROV_CONNECTOR_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE SP_AUTH_SCRIPT_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE SP_TEMPLATE_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_AUTH_WAIT_STATUS_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDP_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDP_ROLE_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDP_ROLE_MAPPING_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDP_CLAIM_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDP_CLAIM_MAPPING_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDP_AUTHENTICATOR_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDP_METADATA_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDP_AUTHENTICATOR_PROP_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDP_PROVISIONING_CONFIG_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDP_PROV_CONFIG_PROP_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDP_PROV_ENTITY_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDP_LOCAL_CLAIM_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_ASSOCIATED_ID_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE WF_WORKFLOW_ASSOCIATION_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_PASSWORD_HISTORY_DATA_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_CLAIM_DIALECT_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_CLAIM_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_CLAIM_MAPPED_ATTRIBUTE_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_CLAIM_PROPERTY_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_CLAIM_MAPPING_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_SAML2_ASSERTION_STORE_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_SAML2_ARTIFACT_STORE_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_OIDC_PROPERTY_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_OIDC_REQ_OBJECT_REF_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_OIDC_REQ_OBJ_CLAIMS_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_OIDC_REQ_OBJ_CLM_VAL_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_CERTIFICATE_SEQUENCE START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_OIDC_SCOPE_CLAIM_MAP_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_OAUTH2_CIBA_SCOPES_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_FED_AUTH_SESSION_MAPPING_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_CORS_ORIGIN_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_OAUTH2_USER_CONSENT_SEQUENCE START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_OAUTH2_USER_CONSENTED_SCOPES_SEQUENCE START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE SP_SHARED_APP_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_UMA_RESOURCE_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_UMA_RESOURCE_META_DATA_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_UMA_RESOURCE_SCOPE_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_UMA_PERMISSION_TICKET_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_UMA_PT_RESOURCE_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE IDN_UMA_PT_RESOURCE_SCOPE_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE CM_PII_CATEGORY_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE CM_PURPOSE_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE CM_PURPOSE_CATEGORY_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE CM_RECEIPT_SP_ASSOC_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE CM_SP_PURPOSE_ASSOC_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE CM_SP_PURPOSE_PPS_CT_ASSC_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE CM_PURPOSE_PII_CAT_ASSOC_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE CM_SP_PURPOSE_PII_CT_ASSC_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE CM_CONSENT_RECEIPT_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE AM_SUBSCRIBER_SEQUENCE START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_APPLICATION_SEQUENCE START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_API_SEQUENCE START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_API_URL_MAPPING_SEQUENCE START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_BACKEND_OPERATION_MAPPING_SEQUENCE START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_API_OPERATION_MAPPING_SEQUENCE START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_API_PRODUCT_MAPPING_SEQ START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_SUBSCRIPTION_SEQUENCE START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_API_RATINGS_SEQUENCE START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_TIER_PERMISSIONS_SEQUENCE START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_API_LC_EVENT_SEQUENCE START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_APP_REGISTRATION_SEQUENCE START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_WORKFLOWS_SEQUENCE START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_EXTERNAL_STORES_SEQUENCE START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_API_DEFAULT_VERSION_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE AM_ALERT_TYPES_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE AM_ALERT_EMAILLIST_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE AM_POLICY_SUBSCRIPTION_seq START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_POLICY_APPLICATION_seq START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_API_THROTTLE_POLICY_seq START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_CONDITION_GROUP_seq START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE QUERY_PARAMETER_CONDITION_seq START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_HEADER_FIELD_CONDITION_seq START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_JWT_CLAIM_CONDITION_seq START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_IP_CONDITION_seq START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_POLICY_GLOBAL_seq START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE THROTTLE_TIER_PERMISSIONS_seq START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_BLOCK_CONDITIONS_seq START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_SYSTEM_APPS_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE AM_API_LC_PUBLISH_EVENTS_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE AM_SCOPE_SEQUENCE START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE AM_GATEWAY_ENV_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE AM_WEBHOOKS_SUBSCRIPTION_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
CREATE SEQUENCE AM_API_ENV_KEYS_SEQUENCE START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_OPERATION_POLICY_DEFINITION_SEQ START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_COMMON_OPERATION_POLICY_SEQ START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_API_OPERATION_POLICY_SEQ START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_API_OPERATION_POLICY_MAPPING_SEQ START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_API_POLICY_MAPPING_SEQ START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_GATEWAY_POLICY_MAPPING_SEQ START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_API_PRIMARY_EP_MAPPING_seq START WITH 1 INCREMENT BY 2
/
CREATE SEQUENCE AM_LLM_PROVIDER_MODEL_seq START WITH 1 INCREMENT BY 2
/
...
CREATE OR REPLACE TRIGGER AM_LLM_PROVIDER_MODEL_seq_tr
                    ...
                    END;
/
CREATE SEQUENCE AM_GW_INSTANCES_SEQ START WITH 1 INCREMENT BY 2 NOCACHE
/
