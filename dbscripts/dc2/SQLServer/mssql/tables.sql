...
CREATE TABLE REG_LOG (
             REG_LOG_ID INTEGER IDENTITY(2,2) NOT NULL,
...
CREATE TABLE  REG_PATH(
             REG_PATH_ID INTEGER IDENTITY(2,2) NOT NULL,
...
CREATE TABLE  REG_CONTENT (
             REG_CONTENT_ID INTEGER IDENTITY(2,2) NOT NULL,
...
CREATE TABLE  REG_RESOURCE (
            ...
            REG_VERSION          INTEGER IDENTITY(2,2) NOT NULL,
...
CREATE TABLE  REG_COMMENT (
            REG_ID      INTEGER IDENTITY(2,2) NOT NULL,
...
CREATE TABLE  REG_RESOURCE_COMMENT (
            REG_RESOURCE_COMMENT_ID     INTEGER NOT NULL IDENTITY(2,2),
...
CREATE TABLE  REG_RESOURCE_RATING (
            REG_RESOURCE_RATING_ID      INTEGER NOT NULL IDENTITY(2,2),
...
CREATE TABLE   REG_RESOURCE_TAG (
            REG_RESOURCE_TAG_ID     INTEGER NOT NULL IDENTITY(2,2),
...
CREATE TABLE  REG_RESOURCE_PROPERTY (
            REG_RESOURCE_PROPERTY_ID    INTEGER NOT NULL IDENTITY(2,2),
...
CREATE TABLE  REG_ASSOCIATION (
            REG_ASSOCIATION_ID  INTEGER IDENTITY(2,2) NOT NULL,
...
CREATE TABLE REG_SNAPSHOT (
            REG_SNAPSHOT_ID     INTEGER IDENTITY(2,2) NOT NULL,
            REG_PATH_ID            INTEGER NOT NULL,
            REG_RESOURCE_NAME            VARCHAR (256),
...
CREATE TABLE UM_TENANT (
			UM_ID INTEGER IDENTITY(2,2) NOT NULL,
...
CREATE TABLE UM_DOMAIN(
            UM_DOMAIN_ID INTEGER IDENTITY(2,2) NOT NULL,
            UM_DOMAIN_NAME VARCHAR(255) NOT NULL,
            UM_TENANT_ID INTEGER DEFAULT 0,
...
CREATE TABLE UM_SHARED_USER_ROLE(
    UM_SHARED_USER_ROLE_ID      INTEGER NOT NULL IDENTITY(2,2),
    UM_ROLE_ID INTEGER NOT NULL,
    UM_USER_ID INTEGER NOT NULL,
...
CREATE TABLE UM_ORG_ROLE_USER (
            UM_ORG_ROLE_USER_ID INTEGER IDENTITY(2,2) NOT NULL,
            UM_USER_ID VARCHAR(255) NOT NULL,
            UM_ROLE_ID VARCHAR(255) NOT NULL,
...
CREATE TABLE UM_ORG_ROLE_GROUP(
            UM_ORG_ROLE_GROUP_ID INTEGER IDENTITY(2,2) NOT NULL,
            UM_GROUP_ID VARCHAR(255) NOT NULL,
            UM_ROLE_ID VARCHAR(255) NOT NULL,
...
CREATE TABLE UM_ORG_ROLE_PERMISSION(
            UM_ORG_ROLE_PERMISSION_ID INTEGER IDENTITY(2,2) NOT NULL,
            UM_PERMISSION_ID INTEGER NOT NULL,
            UM_ROLE_ID VARCHAR(255) NOT NULL,
