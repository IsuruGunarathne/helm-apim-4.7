...
public class ClientAuthenticator {
    ...
    public static String getAccessToken(String scopeList, String appName, String callBackURL, String tokenScope, String appOwner,
        ...
        try {
            ...
            if (applicationKeyBean == null) {
                DCRParamRequest dcrParamRequest = new DCRParamRequest(appName, callBackURL, tokenScope,
                        appOwner, grantType, dcrEndpoint, username, password, tenantDomain);
                applicationKeyBean = makeDCRRequest(dcrParamRequest);
            }
