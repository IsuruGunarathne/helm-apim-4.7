...
public class RestAPIServiceCatalogImpl {
    ...
    public RestAPIServiceCatalogImpl(String username, String password, String tenantDomain, String baseUrl){
        ...
        apiClient.setBasePath(baseUrl + "api/am/service-catalog/v1");
