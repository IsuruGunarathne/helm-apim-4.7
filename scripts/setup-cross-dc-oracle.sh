...
echo "=== WSO2 APIM 4.7 — Cross-DC Event Publisher Setup [Oracle] ==="
echo ""
...
upgrade_cp "$REPO_DIR/distributed/control-plane/azure-values-dc1-oracle.yaml"
...
upgrade_cp "$REPO_DIR/distributed/control-plane/azure-values-dc2-oracle.yaml"
