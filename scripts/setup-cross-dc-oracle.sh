...
upgrade_cp() {
    ...
    helm upgrade cp "$REPO_DIR/distributed/control-plane" -n "$NAMESPACE" \
        ...
        --set-json 'kubernetes.extraVolumeMounts=[{"name":"oracle-driver-vol","mountPath":"/home/wso2carbon/wso2am-acp-4.7.0-beta/repository/components/lib/ojdbc11-23.6.0.24.10.jar","subPath":"ojdbc11-23.6.0.24.10.jar","readOnly":true},{"name":"cross-dc-publishers","mountPath":"/home/wso2carbon/wso2am-acp-4.7.0-beta/repository/deployment/server/eventpublishers/notificationJMSPublisherRegion2.xml","subPath":"notificationJMSPublisherRegion2.xml"},{"name":"cross-dc-publishers","mountPath":"/home/wso2carbon/wso2am-acp-4.7.0-beta/repository/deployment/server/eventpublishers/tokenRevocationJMSPublisherRegion2.xml","subPath":"tokenRevocationJMSPublisherRegion2.xml"},{"name":"cross-dc-publishers","mountPath":"/home/wso2carbon/wso2am-acp-4.7.0-beta/repository/deployment/server/eventpublishers/keymgtEventJMSEventPublisherRegion2.xml","subPath":"keymgtEventJMSEventPublisherRegion2.xml"},{"name":"cross-dc-publishers","mountPath":"/home/wso2carbon/wso2am-acp-4.7.0-beta/repository/deployment/server/eventpublishers/blockingEventJMSPublisherRegion2.xml","subPath":"blockingEventJMSPublisherRegion2.xml"},{"name":"cross-dc-publishers","mountPath":"/home/wso2carbon/wso2am-acp-4.7.0-beta/repository/deployment/server/eventpublishers/asyncWebhooksEventPublisherRegion2.xml","subPath":"asyncWebhooksEventPublisherRegion2.xml"},{"name":"cross-dc-publishers","mountPath":"/home/wso2carbon/wso2am-acp-4.7.0-beta/repository/conf/jndi-region2.properties","subPath":"jndi-region2.properties"}]'
}
