...
echo "=== WSO2 APIM 4.7 — Cross-DC Event Publisher Setup [MSSQL] ==="
echo ""
...
upgrade_cp() {
    ...
    helm upgrade cp "$REPO_DIR/distributed/control-plane" -n "$NAMESPACE" \
        -f "$VALUES_FILE" \
        --set-json 'kubernetes.extraVolumes=[{"name":"mssql-driver-vol","emptyDir":{}},{"name":"cross-dc-publishers","configMap":{"name":"cross-dc-publishers"}}]' \
        --set-json 'kubernetes.extraVolumeMounts=[{"name":"mssql-driver-vol","mountPath":"/home/wso2carbon/wso2am-acp-4.7.0-SNAPSHOT/repository/components/lib/mssql-jdbc-12.8.1.jre11.jar","subPath":"mssql-jdbc-12.8.1.jre11.jar","readOnly":true},{"name":"cross-dc-publishers","mountPath":"/home/wso2carbon/wso2am-acp-4.7.0-SNAPSHOT/repository/deployment/server/eventpublishers/notificationJMSPublisherRegion2.xml","subPath":"notificationJMSPublisherRegion2.xml"},{"name":"cross-dc-publishers","mountPath":"/home/wso2carbon/wso2am-acp-4.7.0-SNAPSHOT/repository/deployment/server/eventpublishers/tokenRevocationJMSPublisherRegion2.xml","subPath":"tokenRevocationJMSPublisherRegion2.xml"},{"name":"cross-dc-publishers","mountPath":"/home/wso2carbon/wso2am-acp-4.7.0-SNAPSHOT/repository/deployment/server/eventpublishers/keymgtEventJMSEventPublisherRegion2.xml","subPath":"keymgtEventJMSEventPublisherRegion2.xml"},{"name":"cross-dc-publishers","mountPath":"/home/wso2carbon/wso2am-acp-4.7.0-SNAPSHOT/repository/deployment/server/eventpublishers/blockingEventJMSPublisherRegion2.xml","subPath":"blockingEventJMSPublisherRegion2.xml"},{"name":"cross-dc-publishers","mountPath":"/home/wso2carbon/wso2am-acp-4.7.0-SNAPSHOT/repository/deployment/server/eventpublishers/asyncWebhooksEventPublisherRegion2.xml","subPath":"asyncWebhooksEventPublisherRegion2.xml"},{"name":"cross-dc-publishers","mountPath":"/home/wso2carbon/wso2am-acp-4.7.0-SNAPSHOT/repository/conf/jndi-region2.properties","subPath":"jndi-region2.properties"}]'
}
...
upgrade_cp "$REPO_DIR/distributed/control-plane/azure-values-dc1-mssql.yaml"
...
upgrade_cp "$REPO_DIR/distributed/control-plane/azure-values-dc2-mssql.yaml"
