...
helm install cp "$REPO_DIR/distributed/control-plane" -n "$NAMESPACE" \
    -f "$REPO_DIR/distributed/control-plane/azure-values-dc1-mssql.yaml"
...
helm install tm "$REPO_DIR/distributed/traffic-manager" -n "$NAMESPACE" \
    -f "$REPO_DIR/distributed/traffic-manager/azure-values-dc1-mssql.yaml"
...
helm install gw "$REPO_DIR/distributed/gateway" -n "$NAMESPACE" \
    -f "$REPO_DIR/distributed/gateway/azure-values-dc1-mssql.yaml"
...
echo ""
echo "========================================="
echo "  DC1 Deployment Complete [MSSQL]"
echo "========================================="
echo ""
